        ...
        <div className="hidden flex-col justify-between py-10 lg:flex">
          ...
          <div className="max-w-2xl">
            ...
            <h1 className="mt-3 text-5xl font-bold tracking-tight">
              Continue your course progress without losing momentum.
            </h1>
            <p className="mt-5 max-w-xl text-base leading-7 text-slate-600">
              Sign in to access enrolled courses, unlock lectures, and keep your
              learning workspace synced.
            </p>
          </div>

          <div className="grid max-w-xl grid-cols-3 gap-3">
            {["Focused paths", "Course access", "Lecture tracking"].map(
              (item) => (
                <div
                  key={item}
          ...
          >
            <div className="mb-8">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-500">
                Enter your account details to open your course dashboard.
              </p>
            </div>
